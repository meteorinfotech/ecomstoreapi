														...
														<tr>
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #44464a; line-height: 1.2; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;">Store Name :
																			 <span style="text-transform:uppercase">{{$storeName->name}}</span> </p>
																	</div>
																</div>
															</td>
														</tr>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div
                                                                            ...
                                                                            <p style="margin: 0; font-size: 14px;">
                                                                                @if(isset($order->variations) && $order->variations  && !empty($order->variations))
